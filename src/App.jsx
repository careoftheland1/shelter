...
function App() {
  ...
  return <main>
    ...
    <section className="process" id="process">
      ...
      <ol>
        <li><span>01</span><div><small>Plans · Details · Material schedule</small><h3>Start with a complete shelter</h3><p>Choose a free plan with dimensioned drawings, assemblies and preliminary quantities—or use <a href="https://buildit.onthe.land/">Build It</a> to test a form of your own.</p><a href="#shelters">Choose a shelter ↗</a></div></li>
